package net.batterbub.batterbubsgolems.block;
...
public class ModBlocks {
    public static final DeferredRegister.Blocks BLOCKS =
            DeferredRegister.createBlocks(GolemMod.MOD_ID);

    public static final DeferredBlock<Block> SPARK_ORE = registerBlock("spark_ore",
            () -> new Block(BlockBehaviour.Properties.of()
                    .strength(4f).requiresCorrectToolForDrops().sound(SoundType.DEEPSLATE)));

    public static final DeferredBlock<Block> GOLEM_SPAWNER = registerBlock("golem_spawner",
            () -> new Block((BlockBehaviour.Properties.of()
